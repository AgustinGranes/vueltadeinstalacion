...
const F2_LOGO = '/categories/f2.png';
const MotoGP_LOGO = '/MOTOGP.png';
const F3_LOGO = '/categories/f3.png';
...
const App = () => {
  ...
  const getCategoryLogo = (category: string) => {
    ...
    if (c.includes('FORMULA NACIONAL')) return '/categories/formulanacional.png';
    if (c.includes('FORMULA 2 ARG') || c === 'F2A') return '/categories/formula2arg.png';
    if (c.includes('FORMULA 3 METRO') || c.includes('FORMULA 3 ARG') || c === 'F3M') return '/categories/formula3arg.png';
    if (c === 'F1' || c === 'FORMULA 1' || c.includes('FORMULA 1')) return F1_LOGO;
    if (c === 'F2' || c === 'FORMULA 2') return F2_LOGO;
    if (c === 'F3' || c === 'FORMULA 3') return F3_LOGO;
    ...
    if (c === 'TC2000' || c.includes('TC 2000') || c.includes('TC2000') || c.includes('TURISMO CARRETERA 2000')) return '/TC2000.png';
    if (c === 'TNC3' || c.includes('TN CLASE 3') || c.includes('TURISMO NACIONAL CLASE 3') || c.includes('TURISMO NACIONAL C3')) return TNC3_LOGO;
    if (c === 'TNC2' || c.includes('TN CLASE 2') || c.includes('TURISMO NACIONAL CLASE 2') || c.includes('TURISMO NACIONAL C2')) return TNC2_LOGO;
    if (c === 'TNBR' || c.includes('TURISMO NACIONAL BRASIL')) return 'https://api.vueltarapida.com/logos/tnbr.png';
    if (c === 'CAA' || c.includes('ABARTH')) return 'https://api.vueltarapida.com/logos/caa.png';
    if (c.includes('TURISMO PISTA') || c.startsWith('TP')) return '/categories/turismopista.png';
    ...
    if (c === 'TOP RACE' || c === 'TOPRACE' || c.includes('TOP RACE')) return '/categories/toprace.png';
            ...
            <AnimatePresence>
              {isLoginOpen && (
                ...
                >
                  ...
                  <div className="filter-actions" style={{ padding: '16px', paddingTop: '0', borderTop: 'none' }}>
