...
const App = () => {
  ...
  const getCategoryLogo = (category: string) => {
    ...
    if (c === 'IMSA' || c === 'IMSA WEATHERTECH SPORTSCAR CHAMPIONSHIP') return IMSA_LOGO;
    if (c === 'TC2000' || c === 'TC 2000') return '/TC2000.png';
    if (c === 'TNC3' || c === 'TN CLASE 3' || c === 'TURISMO NACIONAL CLASE 3') return TNC3_LOGO;
    if (c === 'TNC2' || c === 'TN CLASE 2' || c === 'TURISMO NACIONAL CLASE 2') return TNC2_LOGO;
    if (c === 'TCPK' || c === 'TC PICK UP') return TCPK_LOGO;
